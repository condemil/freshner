...
static const char *MQTT_TOPIC_AVAILABILITY_FORMAT = "esp8266/%06x/availability";

static char HOSTNAME[15];
static char MQTT_TOPIC_STATE[15];
static char MQTT_TOPIC_COMMAND[19];
static char MQTT_TOPIC_AVAILABILITY[28];
